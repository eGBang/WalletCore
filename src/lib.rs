...
#[derive(Debug)]
pub struct WalletCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WalletCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WalletCore processing");
    
    let mut processor = WalletCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WalletCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WalletCoreProcessor::new(false);
